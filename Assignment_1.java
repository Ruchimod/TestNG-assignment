...
public class Assignment_1
{
    ...
    public void report_setup()
    {
        ...
        extent.setSystemInfo("QA_Name","Ruchi");
        extent.setSystemInfo("Build_Name","Version_2.1");
    ...
    public void display_details(String expected_title,String expected_price,String expected_brand,String expected_image_count)
    {
        ...
        for(int i = 0;i < actual_image_count; i++)
        {
         actual_image.add(response.getBody().jsonPath().getString("images["+i+"]"));
        }
